...
<head>
    ...
    <title>Alterar senha - InfoStock</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="login-container">
        ...
        <div class="right-panel">
            ...
            <form action="config/config_senha.php" method="post">
                <div class="input-group">
                    <input type="password" placeholder="Senha" name="senha" required>
                </div>
                <div class="input-group">
                    <input type="password" placeholder="Confirme sua senha" name="senhaConfi" required>
                </div>
                <a href="#" class="forgot-password">Esqueceu a senha?</a>
                <button type="submit" class="login-button">Atualizar senha</button>
